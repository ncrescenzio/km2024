...
\begin{table}[h]\centering
   \begin{tabularx}{0.85\textwidth}{r|X}
      ...
      14:30 - 15:15 & Kratos. Why? What? How? An Historical Perspective \textit{(Pooyan Dadvand \& Riccardo Rossi)}\\%[1ex]
      15:15 - 16:00 & Kratos: an Overview \textit{(Pooyan Dadvand \& Riccardo Rossi)}\\%[1ex]
      \midrule%\rule{0mm}{5mm}
...
\begin{table}[h]\centering
   \begin{tabularx}{0.85\textwidth}{r|X}
      ...
      11:00 - 11:30 & Optimization and System Identification \textit{(Ihar Antonau)} \\%[1ex]
      11:30 - 12:00 & Coupling: the CoSimulationApplication \textit{(Rubén Zorrilla Martínez)}\\%[1ex]
      12:00 - 12:30 & Particle Methods: the MPMApplication \textit{(Antonia Larese)}\\%[1ex]
      \midrule%\rule{0mm}{5mm}
...
\begin{table}[h]\centering
   \begin{tabularx}{0.85\textwidth}{r|X}
      ...
      09:00 - 09:15 & Introduction: What is Kratos? \textit{(Carlos Roig)} \\%[1ex]
      09:15 - 09:45 & Environment Setup and Kratos Installation \textit{(Carlos Roig)} \\%[1ex]
      09:45 - 10:00 & Installation Troubleshooting \textit{(Carlos Roig)} \\%[1ex]
      10:00 - 10:30 & Basic I/O \textit{(Riccardo Rossi)} \\%[1ex]
      \midrule%\rule{0mm}{5mm}
      \rowcolor{SeaGreen3!5!} 10:30 - 11:00 & Coffee Break \\%[1ex]
      \midrule%\rule{0mm}{5mm}
                    & {\large \textbf{Kratos Course (Session 2)}} \\%[1ex]
      11:00 - 11:45 & Geometry Management \textit{(Suneth Warnakulasuriya)} \\%[1ex]
      11:45 - 12:30 & Data Management \textit{(Pooyan Dadvand)} \\%[1ex]
      \midrule%\rule{0mm}{5mm}
      \rowcolor{SeaGreen3!5!} 12:30 - 14:00 & Lunch Break \\%[1ex]
      \midrule%\rule{0mm}{5mm}
                    & {\large \textbf{Kratos Course (Session 3)}} \\%[1ex]
      14:00 - 14:45 & Simulation Loop \textit{(Suneth Warnakulasuriya \& Pooyan Dadvand)} \\%[1ex]
      14:45 - 16:00 & Multiphysics \& Multistage \textit{(Pooyan Dadvand \& Rubén Zorrilla Martínez)} \\%[1ex]
      \midrule%\rule{0mm}{5mm}
      \rowcolor{SeaGreen3!5!} 16:00 - 16:30 & Coffee Break \\%[1ex]
      \midrule%\rule{0mm}{5mm}
